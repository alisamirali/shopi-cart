    ...
    <div className="mb-10 lg:mb-20 bg-shop_light_bg p-5 lg:p-7 rounded-md">
      <div className="flex items-start md:items-center gap-5 justify-between md:mb-8 mb-5 flex-col md:flex-row">
        ...
        <div className="flex items-center justify-end w-full md:w-fit">
          <Link
            href="/shop"
            className="px-4 py-1 hover:text-shop_light_green hover:underline text-sm"
          >
            View All
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2.5">
        {brands?.map((brand) => (
          <Link
            ...
            className="bg-white w-full md:w-34 h-24 flex items-center justify-center rounded-md overflow-hidden hover:shadow-lg shadow-shop_dark_green/20 hoverEffect"
          >
            {brand?.image && (
              <Image
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-16 p-2 shadow-sm py-5">
